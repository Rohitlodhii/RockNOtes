...
export default function SearchDialog() {
    ...
    return (
        <Fragment>
            ...
            {/* Dialog  */}
            <Dialog className=" relative right-[1em] w-[25em]  md:right-0 md:w-0 lg:right-0 lg:w-0" open={open} handler={handleOpen} style={{ background: mode === 'light' ? 'transparent' : 'transparent', color: mode === 'dark' ? 'white' : 'black' }}>
                {/* Dialog Body  */}
                <DialogBody >
                    ...
                    <div className=" text-center">
                        <h1 className=" text-gray-600">Rock-Notes</h1>
                    </div>
                </DialogBody>
            </Dialog>
        </Fragment>
